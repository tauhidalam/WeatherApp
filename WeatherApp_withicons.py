...
def format_response(weather_json):
    try:
        ...
        temp = ((weather_json['main']['temp']-32)*5/9)
        humid = weather_json['main']['humidity']
        feel = ((weather_json['main']['feels_like']-32)*5/9)
        final_str = 'City: %s \nConditions: %s \nTemperature (°C): %.1f \nFeels Like (°C): %.1f \nHumidity: %s' % (city, conditions, temp,round(feel), humid)
    except:
...
def get_weather(city):
    weather_key = "1d2a858940d92b649c9e12d91834d905"
